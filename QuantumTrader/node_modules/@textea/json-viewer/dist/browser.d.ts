...
declare namespace base16 {
  export {
    base16_Colorspace as Colorspace,
    base16_NamedColorspace as NamedColorspace,
    base16_darkColorspace as darkColorspace,
    base16_lightColorspace as lightColorspace,
  };
}
...
declare namespace dataTypes {
  export {
    dataTypes_EasyTypeConfig as EasyTypeConfig,
    dataTypes_bigIntType as bigIntType,
    dataTypes_booleanType as booleanType,
    dataTypes_dateType as dateType,
    dataTypes_defineEasyType as defineEasyType,
    dataTypes_floatType as floatType,
    dataTypes_functionType as functionType,
    dataTypes_intType as intType,
    dataTypes_nanType as nanType,
    dataTypes_nullType as nullType,
    dataTypes_objectType as objectType,
    dataTypes_stringType as stringType,
